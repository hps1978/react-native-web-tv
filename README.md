...
* `focusMode`: Focus startegy to be used. 'LeftTop' tries to bring in the scroll towards Top Left, unless no further scroll is possible. 'default' moves the focus towards the next element spatially. 
