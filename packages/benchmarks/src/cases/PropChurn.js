...
class PropChurn extends React.Component {
  static displayName = 'PropChurn';
    ...
    return (
      <View style={styles.container}>
        {Array.from({ length: NODE_COUNT }).map((_, index) => {
          ...
          return (
            <View
              aria-label={`prop-item-${index}-phase-${phase}`}
